...
function createBackground() {
  return [
    ...
    new BackgroundObject("img/background/layers/3_third_layer/1.png", 718 * 4),
    new BackgroundObject("img/background/layers/2_second_layer/1.png", 718 * 4),
    new BackgroundObject("img/background/layers/1_first_layer/1.png", 718 * 4),
  ]
}
